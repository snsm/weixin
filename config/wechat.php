...
return [
    ...
    'payment' => [
        ...
        'cert_path' => env('WECHAT_PAYMENT_CERT_PATH', base_path('certificate/apiclient_cert_9e99A.pem')), // XXX: 绝对路径！！！！
        'key_path' => env('WECHAT_PAYMENT_KEY_PATH', base_path('certificate/apiclient_key_9e99A.pem')),      // XXX: 绝对路径！！！！
